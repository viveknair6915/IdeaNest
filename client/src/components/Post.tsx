    ...
    return (
        <>
            <div className="mx-4 my-10">
                <div className="border border-solid border-white rounded-xl shadow-2xl justify-evenly items-stretch flex-col w-80 h-70 p-4 ">
                        ...
                        <div className="flex justify-between items-center">
                            <div>
                                <ul className="flex justify-between">
                                    <li className="px-2 border border-solid border-black">
                                        <label htmlFor="file" className="relative">
                                            <input
                                                type="file"
                                                id="file"
                                                name="file"
                                                className="border border-solid border-white absolute inset-0 opacity-0 w-full h-full cursor-pointer"
